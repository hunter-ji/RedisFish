    ...
    <div class="command-content rounded-md">
      ...
      <div class="command-result py-4">
        <div class="command-result-item py-2" v-for="(item, index) in state.history" :key="index">
          ...
          <div class="command-result-item__command text-sm font-bold px-4 py-1 flex items-center justify-start" @click.meta.exact="copyKey(item.command, t('valueContent.notification.copySuccessMessage'))">
          ...
          <div class="command-result-item__result px-4 flex items-center" v-for="(item2, index2) in item.results" :key="index2" @click.meta.exact="copyKey(item2, t('valueContent.notification.copySuccessMessage'))" v-else>
