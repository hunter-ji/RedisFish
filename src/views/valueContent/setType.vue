      ...
      <el-table
        ...
        <el-table-column prop="value" label="Value">
          <template #default="scope">
            ...
            <div v-else>
              <div v-if="scope.row.value.length" :style="'color:' + SwitchColorWithRepeat(scope.row.isRepeat, scope.row.type)" @click.meta.exact="copyKey(scope.row.value, t('valueContent.notification.copySuccessMessage'))">
